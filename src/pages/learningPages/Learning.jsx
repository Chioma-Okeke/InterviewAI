    ...
    return (
        <PageLayout>
            <main className="px-5 lg:px-8 pb-8">
                <div>
                    <p className="text-primary-dark dark:text-primary-light mb-3">Select your career interest</p>
                ...
                <Button className="bg-brand-color text-white py-[14px] px-12 lg:px-16 rounded-lg lg:w-[271px]">Next</Button>
                </div>
                <Link to={`/stages/interestId`} state={{ data }}>
                    stages
                </Link>
            </main>
        </PageLayout>
