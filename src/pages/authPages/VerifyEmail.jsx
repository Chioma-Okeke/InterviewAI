                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="text-center flex flex-col gap-2 text-primary-dark dark:text-primary-light">
                            <p className="hidden sm:block">
                                You’ve entered {userEmail.userEmail} as
                                the email address for your account
                            </p>
                            <p>
                                Kindly check your inbox or spam folder for the verification email.
                            </p>
                        </div>
                        <p className="text-[#3B3B3B] dark:text-ternary-light text-sm flex justify-center gap-1 w-full mt-[118px]">
                                Head to{" "}
                                <Link to={"/auth/login"} className="text-[#3D9963]">
                                    login page
                                </Link>
                            </p>
                        <div className="hidden">
                            <Button
                                onClick={verifyUser}
                                className="w-full mt-8 mb-6 text-white py-[18px] px-5 rounded-[15px] bg-[#3D9963] max-w-[300px] mx-auto"
                            >
                                Verify your email
                            </Button>
                            <p className="text-[#3B3B3B] dark:text-ternary-light text-sm flex justify-center gap-1 w-full mt-[118px]">
